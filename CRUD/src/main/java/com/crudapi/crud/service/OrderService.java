...
public class OrderService {
    ...
    public List<OrderResponseDTO> getOrders(OrderFilterDTO filter) {

        try {
            OrderSortField sortField = filter.getSortField() != null ? filter.getSortField() : OrderSortField.CREATIONDATETIME;
