...
public class EmployeeService {
    ...
    private final EmployeeMapper<EmployeeResponseDTO, Employee> employeeMapper;


    public EmployeeService(EmployeeRepository employeeRepository, BCryptPasswordEncoder passwordEncoder, EmployeeMapper<EmployeeResponseDTO, Employee> employeeMapper) {
    ...
    public Page<Employee> getAllEmployees (EmployeeFilterDTO filter) {
        try {
            SortField sortField = filter.getSortField() != null ? filter.getSortField() : SortField.ID;
